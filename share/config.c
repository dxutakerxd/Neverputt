...
int CONFIG_HAPTIC;
int CONFIG_TOUCH_SENSE;
int CONFIG_AD_FREE;
int CONFIG_AD_INTERVAL;
int CONFIG_WALLET_SEEKER;
...
static struct
{
    ...
    { &CONFIG_HAPTIC,         "haptic",         1 },
    { &CONFIG_TOUCH_SENSE,    "touch_sense",    5 },
    { &CONFIG_AD_FREE,        "ad_free",        0 },
    { &CONFIG_AD_INTERVAL,    "ad_interval",    3 },
    { &CONFIG_WALLET_SEEKER,  "wallet_seeker",  0 },
};
