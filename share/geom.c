...
void back_init(const char *name)
{
    ...
    strncpy(back_name, name, sizeof(back_name) - 1);
    back_name[sizeof(back_name) - 1] = '\0';
...
void back_reload(void)
{
    char name[MAXSTR];

    if (back_name[0])
    {
        strncpy(name, back_name, sizeof(name) - 1);
